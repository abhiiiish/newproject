...
def home():
    if request.method == 'POST':
        ...
        prompt = f"generate description of {company_name} establish in year {establishment} and situated in {location}, including services {services}.Also give brief about services."
